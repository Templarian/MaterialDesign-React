...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Icon.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
const Icon = ({ path, size = 1, color = '', horizontal = false, vertical = false, rotate = 0, spin = false }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("svg", { viewBox: "0 0 24 24", style: {
        ...
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("path", { d: path, style: {
                fill: color
            } })));
};
Icon.propTypes = {
    path: prop_types__WEBPACK_IMPORTED_MODULE_1__["string"].isRequired,
    ...
    rotate: prop_types__WEBPACK_IMPORTED_MODULE_1__["number"],
    spin: prop_types__WEBPACK_IMPORTED_MODULE_1__["oneOfType"]([
